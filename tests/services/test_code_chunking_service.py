...
# ============================================================================
# NOTE (EPIC-13): Advanced metadata extraction (signature, parameters, returns,
# LSP type information, etc.) is now handled by MetadataExtractorService and
# TypeExtractorService in the full indexing pipeline, not by CodeChunkingService.
#
# The following tests (tests 11-19) have been REMOVED as they tested the old
# extract_metadata parameter which no longer exists.
#
# For LSP metadata extraction tests, see:
# - tests/integration/test_epic13_*.py (EPIC-13 LSP integration tests)
# - tests/services/test_metadata_extractor_service.py (metadata extraction)
# - tests/services/test_type_extractor_service.py (LSP type extraction)
#
# The CodeChunkingService now focuses solely on AST-based code chunking.
# ============================================================================
